...
//   string file = "output/vtp/3d/data_" + to_string(iter) + ".vtp";
...
//     for (int j = 0; j < CIRC_NUM; j++)
//     {
//       double theta = 2 * PI * j / CIRC_NUM;
//       double r = sqrt(area[i] / PI);
//       fprintf(fp, "%e %e %e\n", r * cos(theta), r * sin(theta), x[i]);
//     }
//   }
//   fprintf(fp, "</DataArray>\n");
//   fprintf(fp, "</Points>\n");
...
//     {
//       int k1 = i * CIRC_NUM + j;
//       int k2 = i * CIRC_NUM + (j + 1) % CIRC_NUM;
//       int k3 = (i + 1) * CIRC_NUM + (j + 1) % CIRC_NUM;
//       int k4 = (i + 1) * CIRC_NUM + j;
//       fprintf(fp, "4 %d %d %d %d\n", k1, k2, k3, k4);
//     }
//   }
//   fprintf(fp, "</DataArray>\n");
//   fprintf(fp, "<DataArray type=\"Int32\" Name=\"offsets\" format=\"ascii\">\n");
//   for (int i = 0; i < (NODE_NUM - 1) * CIRC_NUM; i++)
//   {
//     fprintf(fp, "%d\n", (i + 1) * 4);
//   }
//   fprintf(fp, "</DataArray>\n");
...
//   // Point data can be added similarly
